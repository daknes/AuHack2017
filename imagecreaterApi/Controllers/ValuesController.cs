    ...
    public class ValuesController : ApiController
    {
        ...
        private Stream GenerateImage(Stream stream)
        {
           ...
           // bitmap = RotateImage(bitmap, 90);
            ...
            Font f = new Font("Impact", 160, FontStyle.Bold, GraphicsUnit.Pixel);
            ...
            for (int i = 0; i < memelines.Count; i++)
            {
                ...
                Rectangle r = new Rectangle(75, 25 + (163 * i), bitmap.Width, bitmap.Height);
                //Rectangle r = new Rectangle(0, (43 * i), bitmap.Width, bitmap.Height);

                gp.AddString(memelines[i], f.FontFamily, (int)f.Style, 160, r, stringformat);
